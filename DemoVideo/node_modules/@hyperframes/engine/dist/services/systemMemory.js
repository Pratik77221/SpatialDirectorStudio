 ...
 */
export function getCgroupMemoryLimitMb() {
    ...
    if (_cachedCgroupLimitMb !== null) {
        ...
        console.warn(`[SystemMemory] cgroup memory limit detected: ${_cachedCgroupLimitMb} MiB — ` +
...
//# sourceMappingURL=systemMemory.js.map