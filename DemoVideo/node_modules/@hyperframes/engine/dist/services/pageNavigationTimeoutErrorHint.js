...
export function augmentPageNavigationTimeoutError(err, effectiveTimeoutMs, context = {}) {
    if (!(err instanceof Error))
        return new Error(String(err));
    if (!NAVIGATION_TIMEOUT_MATCHER.test(err.message))
        return err;
 ...
 * drift.
 */
export function isPageNavigationTimeoutError(err) {
...
//# sourceMappingURL=pageNavigationTimeoutErrorHint.js.map