...
export function augmentProtocolTimeoutError(err, effectiveTimeoutMs) {
    if (!(err instanceof Error))
        return new Error(String(err));
    if (!PROTOCOL_TIMEOUT_MATCHER.test(err.message))
        return err;
 ...
 */
export function isProtocolTimeoutError(err) {
    const message = err instanceof Error ? err.message : typeof err === "string" ? err : "";
    return PROTOCOL_TIMEOUT_MATCHER.test(message);
}
//# sourceMappingURL=protocolTimeoutErrorHint.js.map