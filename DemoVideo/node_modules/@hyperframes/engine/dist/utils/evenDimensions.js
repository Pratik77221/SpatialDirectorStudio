 ...
 */
export function requiresEvenDimensions(pixelFormat) {
 ...
 */
export function withEvenDimensionPad(vfChain, pixelFormat, width, height) {
    if (!requiresEvenDimensions(pixelFormat))
        return vfChain;
...
//# sourceMappingURL=evenDimensions.js.map