 ...
 * centralized here.
 */
import { type BeforeCaptureHook, type CaptureSession, type ElementStackingInfo } from "@hyperframes/engine";
import type { ProducerLogger } from "../../../logger.js";
import { type HdrCompositeContext, type HdrVideoFrameSource, type TransitionRange } from "../../hdrCompositor.js";
import { type HdrPerfCollector, type HdrPerfTimingKey } from "../hdrPerf.js";
/**
 ...
 */
export declare function seekInjectAndQueryStacking(page: CaptureSession["page"], time: number, beforeCaptureHook: BeforeCaptureHook | null, nativeHdrIds: Set<string>, hdrPerf: HdrPerfCollector | undefined, seekKey: HdrPerfTimingKey, injectKey: HdrPerfTimingKey, stackingKey: HdrPerfTimingKey): Promise<ElementStackingInfo[]>;
 ...
 */
export declare function ensureFrameWritten(frameWritten: boolean, frameIndex: number, encoder?: {
