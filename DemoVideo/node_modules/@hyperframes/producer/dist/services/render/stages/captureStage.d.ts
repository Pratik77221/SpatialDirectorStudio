 ...
 */
import { type BeforeCaptureHook, type CaptureOptions, type CapturePerfSummary, type CaptureSession, type EngineConfig } from "@hyperframes/engine";
 ...
 */
export declare function shouldAllowAdaptiveCaptureRetry(workerCount: number, _explicitlyConfigured: boolean): boolean;
export declare function estimateDiskCaptureBytes(totalFrames: number, captureOptions: CaptureOptions): number;
export declare function assertDiskCaptureHeadroom(framesDir: string, totalFrames: number, captureOptions: CaptureOptions, freeDiskBytes?: (path: string) => number | null): void;
