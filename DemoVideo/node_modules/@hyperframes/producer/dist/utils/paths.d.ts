...
export declare function formatCaptureFrameName(index: number, ext: string): string;
export declare function formatExportFrameName(index: number, ext: string): string;
