 ...
 */
export function isSafePath(base, resolved) {
    let baseReal;
    try {
    ...
    for (;;) {
        ...
        try {
            ...
            if (!isMissingPath(probe))
                return false;
            const parent = dirname(probe);
            if (parent === probe)
                return false; // walked past the filesystem root
 ...
 */
export function resolveWithinProject(base, relativePath) {
