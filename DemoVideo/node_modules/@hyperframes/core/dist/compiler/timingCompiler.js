...
import { parseStrictFiniteTimingNumber, readElementPlaybackRate, readMediaStart, } from "../runtime/playbackRate.js";
 ...
 */
export function shouldClampResolvedMediaDuration(tagName, declaredDuration, maxDuration) {
...
function setAttr(tag, attr, value) {
    if (!hasAttr(tag, attr))
        return injectAttr(tag, attr, value);
...
const INERT_REGION_RE = /<!--[\s\S]*?-->|<script\b[\s\S]*?<\/script\s*>|<style\b[\s\S]*?<\/style\s*>/gi;
