 ...
 */
export function setFrameField(source, frameIndex, key, value, opts = {}) {
    const lines = source.split(/\r?\n/);
    const target = frameBounds(lines)[frameIndex - 1];
    if (!target)
        throw new Error(`storyboard frame ${frameIndex} not found`);
...
export function setFrameVoiceover(source, frameIndex, value) {
...
export function setFrameStatus(source, frameIndex, status) {
    return setFrameField(source, frameIndex, "status", status);
}
//# sourceMappingURL=editStoryboard.js.map