 ...
 */
import { HF_AUDIO_AUTOMATION_ATTR, parseAutomation, sampleAutomationLane, VOLUME_TARGET, } from "../audioAutomation.js";
/**
 ...
 */
export function elementVolumeLaneGain(el, relTime) {
    const raw = (typeof el.getAttribute === "function" ? el.getAttribute(HF_AUDIO_AUTOMATION_ATTR) : null) ??
        "";
    if (!raw)
        return null;
...
//# sourceMappingURL=audioAutomationVolume.js.map