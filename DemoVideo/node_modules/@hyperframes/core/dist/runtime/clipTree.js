 ...
 */
import { parseStrictFiniteTimingNumber, resolveNaturalMediaTimelineDuration } from "./playbackRate.js";
 ...
 */
export function stableClipId(el) {
    return el.id || el.getAttribute("data-hf-id") || null;
}
