...
export declare const HYPERFRAME_CONTROL_ACTIONS: readonly ["play", "pause", "seek", "set-muted", "set-playback-rate", "set-color-grading", "set-color-grading-compare", "enable-pick-mode", "disable-pick-mode"];
